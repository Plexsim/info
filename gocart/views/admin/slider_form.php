...
<?php echo form_open_multipart($this->config->item('admin_folder').'/slider/form/'.$id); ?>
...
<div class="tabbable">
	...
	<div class="tab-content">
		...
		<div class="tab-pane" id="image_tab">
			<p><?php echo lang('best_photo_size')?>: <b><?php echo lang('width')?>: 640px, <?php echo lang('height')?>: 500px </b></p>
