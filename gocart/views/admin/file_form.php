...
<?php echo form_open_multipart($this->config->item('admin_folder').'/files/form/'.$id); ?>

	
        
        <div class="btn-group pull-right">
			<a class="btn" href="<?php echo site_url($this->config->item('admin_folder').'/files'); ?>"><i class="icon-plus-sign"></i> Back to File Listing </a>	
		</div>
