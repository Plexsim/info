<div id="wrapper">
    ...
    <div id="content">
       ...
       <div class="sliderbg">
            ...
            <!--div class="image_single radius4"><img src="<?php echo theme_img('page_photo.jpg') ?>" alt="" title="" border="0" /></div>
            <div class="image_caption green green_borderbottom radius4"><?php echo $profile['display_name'] ?></div-->
            <div>
